    ...
    return(
        <div id="about" className="relative bg-white overflow-hidden mt-16">
            ...
            <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                <img className="h-56 w-full object-cover object-top sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://res.cloudinary.com/dzlveh6fi/image/upload/v1717756752/about_pic_jlrvfb.jpg" alt=""/>
            </div>
        </div>
    )
}