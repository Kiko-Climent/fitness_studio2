...
export default function Features2() {
    ...
    return(
        <div className="text-center py-32">
            <animated.div style={props} className={`text-5xl font-bold tracking-tight text-[#7ef455] custom-strike-sections ${strikeActive ? 'active' : ''}`}
            >
            ...
            <div className="flex flex-wrap items-center mt-20 text-left text-center">
                ...
                <div className="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
                    ...
                    <animated.h3 style={textAnimation} className="font-bold mt-8 lg:text-5xl md:mt-0 sm:text-2xl text-[#7ef455]">
                        cardio.
                    </animated.h3>
                    <animated.div style={lineAnimation} className="bg-[#7ef455] h-1"></animated.div>
            ...
            <div className="flex flex-wrap items-center mt-20 text-left text-center">
                ...
                <div className="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-12">
                    <h3 className="font-bold mt-8 lg:text-5xl md:mt-0 sm:text-2xl text-[#7ef455]">
