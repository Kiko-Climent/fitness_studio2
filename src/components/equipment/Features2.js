export default function Features2() {
    ...
    <div class="flex flex-wrap items-center mt-20 text-left text-center">
        <div class="w-full md:w-3/5 lg:w-1/2 px-4">
            <img src="https://res.cloudinary.com/dzlveh6fi/image/upload/v1718107268/david-marioni-F_lns58a_ec-unsplash_xqgype.jpg" alt="gem" class="inline-block rounded shadow-lg border border-merino-400"/>
        </div>
    ...
    <div class="flex flex-wrap items-center mt-20 text-left text-center">
        <div class="w-full md:w-3/5 lg:w-1/2 px-4">
            <img src="https://res.cloudinary.com/dzlveh6fi/image/upload/v1718104888/anastase-maragos-FP7cfYPPUKM-unsplash_odwhbv.jpg" alt="project members" class="inline-block rounded shadow-lg border border-merino-400"/>
        </div>
    ...
    <div class="flex flex-wrap items-center mt-20 text-left  text-center">
        <div class="w-full md:w-3/5 lg:w-1/2 px-4">
            <img src="https://res.cloudinary.com/dzlveh6fi/image/upload/v1718105228/sauna2_xbrun1.jpg" alt="editor" class="inline-block rounded shadow-lg border border-merino-400"/>
        </div>
        <div class="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
            <h3 class="font-bold mt-8 text-xl md:mt-0 sm:text-2xl">
    ...
    <div class="flex flex-wrap items-center mt-20 text-left text-center">
        <div class="w-full md:w-3/5 lg:w-1/2 px-4">
            <img src="https://res.cloudinary.com/dzlveh6fi/image/upload/v1718107680/highlight-id-TSZnGmHRdmk-unsplash_ynfxsu.jpg" alt="bulk editing" class="inline-block rounded shadow-lg border border-merino-400"/>
        </div>
        <div class="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-12">
            <h3 class="font-bold mt-8 text-xl md:mt-0 sm:text-2xl">
                Bulk editing
