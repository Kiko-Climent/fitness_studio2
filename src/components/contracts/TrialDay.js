        ...
        <div className="bg-white pb-12 sm:pb-20">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="p-8 sm:p-10 lg:flex-auto">
                    <h3 className="text-5xl font-bold tracking-tight text-[#7ef455] text-center lg:text-left">trial day ticket.</h3>
                ...
                <div className="-mt-2 lg:mt-16 lg:w-full lg:max-w-md lg:flex-shrink-0">
