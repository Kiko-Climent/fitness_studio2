        ...
        >
            ...
            <div className="flex flex-1 flex-col justify-between bg-white p-6">
                <div className="flex-1">
                    <div className="block">
                        <p id={`title-${index}`} className=" pt-4 pb-8 text-2xl lg:text-4xl font-bold transition duration-400 ease-in-out text-[#7ef455]">{data.name}</p>
                        <p className="-mt-6 text-sm lg:text-xl space-y-2 leading-6 text-[#2c555b]">{data.description}</p>
                    </div>
                </div>
            </div>
        </Link>
